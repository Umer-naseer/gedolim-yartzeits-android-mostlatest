...
public class DatePickerPopWin extends PopupWindow implements OnClickListener {
    ...
    private void initView() {
        ...
        cancelBtn = (TextView) contentView.findViewById(R.id.textView_cancel);
        confirmBtn = (TextView) contentView.findViewById(R.id.textView_confirm);
    ...
    public static long getLongFromyyyyMMdd(String date) {
        SimpleDateFormat mFormat = new SimpleDateFormat("yyyy-MMMM-dd", Locale.getDefault());
        Date parse = null;
        try {
    ...
    public static String getStrDate() {
        SimpleDateFormat dd = new SimpleDateFormat("yyyy-MMMM-dd", Locale.CHINA);
